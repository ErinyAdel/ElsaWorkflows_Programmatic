...
builder.Services.AddElsa(elsa =>
{
    ...
    //elsa.AddWorkflow<BraidedWorkflow>();
    //elsa.AddWorkflow<HttpHelloWorld>();
    //elsa.AddWorkflowsFrom<HTTPAPIWorkflow>();
    //elsa.AddWorkflow<HttpBackendAPIWorkflow>();
    //elsa.AddWorkflow<ReceiveAndSendUserWorkflow>();
